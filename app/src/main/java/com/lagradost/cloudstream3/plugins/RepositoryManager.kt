...
object RepositoryManager {
    ...
    val PREBUILT_REPOSITORIES: Array<RepositoryData> by lazy {
        AppPreferenceManager.getStringSync("PREBUILT_REPOSITORIES")?.let {
            parseJson<Array<RepositoryData>>(it)
        } ?: emptyArray()
    }
    ...
    fun convertRawGitUrl(url: String): String {
        if (!AppPreferenceManager.getBooleanSync("jsdelivr_proxy_key", false)) return url
    ...
    fun getRepositories(): Array<RepositoryData> {
        return AppPreferenceManager.getStringSync(REPOSITORIES_KEY)?.let {
            parseJson<Array<RepositoryData>>(it)
        } ?: emptyArray()
    }
    ...
    suspend fun addRepository(repository: RepositoryData) {
        repoLock.withLock {
            ...
            AppPreferenceManager.setStringSync(REPOSITORIES_KEY, toJson(updated))
        }
    }
    ...
    suspend fun removeRepository(context: Context, repository: RepositoryData) {
        ...
        repoLock.withLock {
            ...
            AppPreferenceManager.setStringSync(REPOSITORIES_KEY, toJson(newRepos))
        }
