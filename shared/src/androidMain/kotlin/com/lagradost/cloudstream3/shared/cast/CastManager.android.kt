...
/**
 * Android implementation of [CastManager] supporting Google Cast & UPnP/DLNA rendering.
...
actual class CastManager actual constructor() {
    private val client = UPnPCastClient(
        onCustomDiscovery = {
            // Safe runtime check for Google Cast / MediaRouter if available on Android
            try {
