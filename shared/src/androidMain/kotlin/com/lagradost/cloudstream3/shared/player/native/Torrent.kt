...
object Torrent {
    ...
    @Throws
    fun deleteAllFiles(dir: File? = null): Boolean {
        val baseDir = dir ?: cacheDir ?: return false
        val defaultDirectory = "${baseDir.path}/$TORRENT_SERVER_PATH"
    ...
    @Throws
    suspend fun transformLink(link: ExtractorLink, dir: File? = null): Pair<ExtractorLink, TorrentStatus> {
        val baseDir = dir ?: cacheDir ?: File(System.getProperty("java.io.tmpdir"), "cs_torrent")
        val defaultDirectory = "${baseDir.path}/$TORRENT_SERVER_PATH"
